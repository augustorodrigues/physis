...
<head>
	...
	<title>Editar Usuário | Physis</title>
...
<body>
	<?php
		...
		$sql = "SELECT * FROM physis_usuario WHERE id_usuario = $id LIMIT 1;";
					...
					<div>
						...
						<fieldset> <legend>Cadastro de usuário</legend>
							<div class="form-group">
								...
								<input type="text" name="tNome" id="cNome" class="form-control" value="<?php echo $exibe['nome']; ?>">
							</div>

							<div class="form-group">
								<label for="cDocumento">Documento (CPF ou RG)</label>
								<input type="text" name="tDocumento" id="cDocumento" class="form-control" placeholder="CPF ou RG" value="<?php echo $exibe['documento']; ?>">
							</div>

							<div class="form-group">
								<label for="cDataNasc">Data de Nascimento:</label> 
								<input type="date" name="tDataNasc" id="cDataNasc" class="form-control" value="<?php echo $exibe['nascimento']; ?>">
							</div>					
							
							<div class="form-group">
								<label for="cEmail">E-mail</label> 
								<input type="email" class="form-control" name="tEmail" id="cEmail" maxlength="40" placeholder="digite um e-mail válido" value="<?php echo $exibe['email']; ?>">
							</div>
